...
(function (root, factory) {
	...
	angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', '$compile',
		function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate, $compile) {
			// keyboard events
			var KEY_DW  = 40;
			var KEY_RT  = 39;
			var KEY_UP  = 38;
			...
			function elementRect(element){
				var bodyRect = document.body.getBoundingClientRect(),
				    ...
				    offsetTopOrigin   = elementRect.top - bodyRect.top,
				    offsetLeftOrigin   = elementRect.left - bodyRect.left;
			...
			function link(scope, elem, attrs, ctrl) {
				...
				angular.element(document.body).append(compiledAutocompleteEl);
