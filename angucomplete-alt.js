...
angular.module('angucomplete-alt', [] )
  ...
  $templateCache.put(TEMPLATE_URL,
      ...
      '  <div class="angucomplete-show-all" ng-class="{disabled: showDropdownAllDisabled}" ng-click="showDropdownAllDisabled || (showDropdownAll = !showDropdownAll)" ng-show="showAll"></div>' +
