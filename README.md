...
| more-results | A callback function. It gets called when a tag element with `ng-click="getMoreResults()"` is clicked, need to override default template using `template-url`. | No | more_results |
