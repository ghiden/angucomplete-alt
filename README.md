...
| search-fields | The fields from your local data to search on (comma separate them). [example](http://ghiden.github.io/angucomplete-alt/#example1) | No | title,description |
